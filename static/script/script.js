function toggleMode(isVGS) {
  ...
  if (isVGS) {
    ...
    if (themeStyle.getAttribute("href") === "/static/css/VGS-light.css") {
      themeStyle.href = "/static/css/VGS-dark.css";
      currentMode = "dark";
    } else {
      themeStyle.href = "/static/css/VGS-light.css";
      currentMode = "light";
    }
  } else {
...
function applySavedTheme(isVGS) {
  ...
  if (isVGS) {
    themeStyle.href = savedTheme === 'dark' ? "/static/css/VGS-dark.css" : "/static/css/VGS-light.css";
  } else {
