...
client = pymongo.MongoClient("mongodb+srv://ssanjeevarasa:3sz8TqQkgj2xNvxs@results.szk52.mongodb.net/?retryWrites=true&w=majority&appName=results")
db = client["test"]
# Get the collection
collection = db["mongodb_results"]
